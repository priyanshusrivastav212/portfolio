...
const TechStackItem: React.FC<TechStackItemProps> = ({ icon, title, description, skillLevel }) => {
  return (
    ...
    <div id="techstack" className="h-fit w-full">
      <section className="bg-zinc-900 py-5 flex flex-col justify-center items-center w-full text-gray-100 h-fit">
        ...
        <div className="container mx-auto grid justify-center gap-7 sm:grid-cols-4">
          ...
          />
          <TechStackItem
            icon={<FaBootstrap className="w-12 h-12 text-white" />}
            title="Bootstrap"
          ...
          />
          <TechStackItem
            icon={<DiMongodb className="w-12 h-12 text-white" />}
            title="MongoDB"
          ...
          />
          <TechStackItem
            icon={<RiSupabaseFill className="w-12 h-12 text-white" />}
            title="Supabase"
            description="An open-source alternative to Firebase."
            skillLevel="Intermediate"
          />
          <TechStackItem
            icon={<FaPython className="w-12 h-12 text-white" />}
            title="Python"
            description="A programming language used for web development, data science, and more."
            skillLevel="Advanced"
          />
        </div>
      </section>
